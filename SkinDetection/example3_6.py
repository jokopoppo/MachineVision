...
for im_id in range(1,4):
    print(im_id)
    im = cv2.imread("D:/MachineVision/SkinDetection/SkinTrain"+str(im_id)+".jpg")
    mask = cv2.imread("D:/MachineVision/SkinDetection/SkinTrain"+str(im_id)+"_mask.jpg",0)
...
im = cv2.imread("D:/MachineVision/SkinDetection/SkinTest1.jpg")
